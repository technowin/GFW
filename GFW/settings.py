...
DATABASES = {
    'default': {
        ...
        'NAME': 'gfw_db',      # Replace with your database name
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            # 'filename': os.path.join(BASE_DIR, 'D:/Python Projects/GFW logs', 'django.log'),  
            'filename': os.path.join(BASE_DIR, '/home/ubuntu/GFW logs', 'django.log'),  
        },
    },
    'loggers': {
        'django': {
...
WSGI_APPLICATION = 'GFW.wsgi.application'
